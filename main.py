...
async def main():
    ...
    {white}Referral Link : {green}https://app.getgrass.io/register?referralCode=Qj0nK0iL4SRgIT8
    {white}Telegram : {green}https://web.telegram.org/k/#@shadowscripters
...
console.log("Python script content displayed above. This script cannot be executed in a JavaScript environment.")